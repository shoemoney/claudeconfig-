...
Control Google Chrome browser through Claude using AppleScript automation.
...
### `list_tabs`
List all open tabs across all Chrome windows.
...
This extension requires access to control Google Chrome through AppleScript. It can:
